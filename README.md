...
There is also condor_plot a command that plots similar information in a HTML page. You can have bar plots, pie charts and more.


Workload Analysis 
-----------------
Our Cycleserver website is an analytics tool that users should keep at hand while submitting jobs into OSG Connect. You can visit it here: http://monitor.osgconnect.net
